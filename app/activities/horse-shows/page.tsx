        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="flex-1 flex justify-center">
              <Image src="/images/competition.jpeg" alt="Academy Class" width={500} height={350} className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 flex justify-center">
              <Image src="/images/horse-lesson.jpeg" alt="Ready" width={500} height={350} className="object-cover" />
            </div>
            <div className="flex-1">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            <div className="flex-1 flex justify-center">
              <Image src="/images/competition.jpeg" alt="Set" width={500} height={350} className="object-cover" />
            </div>
            <div className="flex-1">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 flex justify-center">
              <Image src="/images/drill-team.jpeg" alt="Ride" width={500} height={350} className="object-cover" />
            </div>
            <div className="flex-1">
      ...
      <section className="py-16 bg-lhra-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            <Image src="/images/competition.jpeg" alt="Academy Nationals 1" width={300} height={200} className="object-cover" />
            <Image src="/images/horse-lesson.jpeg" alt="Academy Nationals 2" width={300} height={200} className="object-cover" />
            <Image src="/images/drill-team.jpeg" alt="Academy Nationals 3" width={300} height={200} className="object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-lhra-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <Image src="/images/horse-lesson.jpeg" alt="Performance Classes 1" width={300} height={200} className="object-cover" />
            <Image src="/images/competition.jpeg" alt="Performance Classes 2" width={300} height={200} className="object-cover" />
            <Image src="/images/drill-team.jpeg" alt="Performance Classes 3" width={300} height={200} className="object-cover" />
          </div>
        </div>
      </section>
