    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="elegant-gradient text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="elegant-heading text-4xl font-bold mb-4">Our Staff</h1>
      ...
      <section className="py-24 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            {/* Ava Gamble */}
            <div className="bg-white rounded-xl shadow-lg border-2 border-lhra-yellow p-6 flex flex-col items-center">
              <Image src="/images/Ava.jpg" alt="Ava Gamble" width={220} height={180} className="rounded-lg mb-4 object-contain" />
