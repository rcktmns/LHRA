  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-lhra-blue/95 z-10" />
        ...
        <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="mb-4 inline-block">
            ...
            <h1 className="font-papyrus text-xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-2 drop-shadow-lg tracking-wider">
              RIDE WITH THE PRIDE
            </h1>
            <div className="h-1 bg-yellow-500 w-1/3 mx-auto mb-2"></div>
          </div>

          <p className="font-lexend text-sm sm:text-base md:text-lg lg:text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-12 bg-lhra-red">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-papyrus text-2xl font-bold text-white text-center mb-8">Our Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Service Card 1: Riding Lessons */}
            <Link href="/lessons/classes" className="bg-white rounded-xl shadow-lg border-2 border-lhra-yellow p-3 transition-all duration-200 hover:scale-105 hover:shadow-xl flex flex-col items-center text-center">
            ...
            <Link href="/activities/camps" className="bg-white rounded-xl shadow-lg border-2 border-lhra-yellow p-3 transition-all duration-200 hover:scale-105 hover:shadow-xl flex flex-col items-center text-center">
            ...
            <Link href="/activities/horse-shows" className="bg-white rounded-xl shadow-lg border-2 border-lhra-yellow p-3 transition-all duration-200 hover:scale-105 hover:shadow-xl flex flex-col items-center text-center">
